...
ASeller = Agent(
    ...
    backstory="A loja 1 é responsável por vender roupas esportivas, a loja 2 roupas sociais e de grife, a loja 3 vende itens para celular e a loja 4 vende livros",
