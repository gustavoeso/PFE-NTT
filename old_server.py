...
Em final_offer, defina se esta sendo feito uma oferta ou não:
- Se for uma oferta, use "final_offer": true. Ex: Temos a camiseta branca disponível no tamanho G. Ela é feita de algodão e possui uma estampa que é o logo da Nike. O preço é R$12,50 e temos 2 unidades em estoque. 
- Se não for uma oferta, use "final_offer": false. Ex: De qual tamanho você gostaria? Temos tamanhos P e G disponíveis.
"""
